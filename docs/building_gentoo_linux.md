...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| dev-python/pip | dev-build/cmake | dev-vcs/git | media-libs/mesa | media-libs/glu |
| x11-libs/libXinerama | x11-libs/libXrandr | media-libs/fontconfig | media-sound/pulseaudio |
